...
if ($err == 0){
    ...
    if ($PRODUCT_ID = $el->Add($arElem)){
        ...
        $arResult['msg'][] = array(
            'text' =>'<span style="color: green">Ваши данные отправлены!</span><br>Ожидайте звонка.',
            'type' => true
        );
        ...
        // отправка почты
        CEvent::Send("NEW_USER_RESPONSE2", "s1", $arEventFields);
