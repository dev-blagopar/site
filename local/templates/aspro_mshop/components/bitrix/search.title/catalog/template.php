	...
	<div id="<?echo $CONTAINER_ID?>" class="stitle_form">
		<form action="<?echo $arResult["FORM_ACTION"]?>">
			<div class="form-control1 bg">
				<input id="<?echo $INPUT_ID?>" type="text" name="q" value="" size="40" class="text small_block" maxlength="50" autocomplete="off" placeholder="<?=GetMessage("SEARCH_PLACEHOLDER");?>" /><input name="s" type="submit" value="<?=GetMessage("CT_BST_SEARCH_BUTTON");?>" class="button icon" />
			</div>
		</form>
	</div>
<?endif?>
