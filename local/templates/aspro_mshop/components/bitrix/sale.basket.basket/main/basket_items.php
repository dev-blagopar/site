						...
						<?foreach ($arResult["GRID"]["HEADERS"] as $id => $arHeader):
							...
							<?elseif ($arHeader["id"] == "QUANTITY"):?>
								<td class="count-cell">
                                    ...
                                    <? /*
									<?if($arItem["QUANTITY"]>$arItem["AVAILABLE_QUANTITY"]):?><div class="error" style="color:red;"><?=GetMessage("NO_NEED_AMMOUNT")?><br/>(доступно <?=$arItem["AVAILABLE_QUANTITY"]?>)</div><?endif;?>
                                    */ ?>
