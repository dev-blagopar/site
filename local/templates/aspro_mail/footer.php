		...
		<!-- footer -->
			<div style="max-width: 600px;min-width:600px !important;width:100% !important;text-align:center;margin:0px auto;">
				<?global $copyright, $vk_social, $fb_social, $odn_social, $tw_social, $mail_social, $inst_social, $g_social, $y_social, $tiktok_social, $pinterest_social, $yandexzen_social, $snapchat_social, $linkedin_social, $telegram_social, $viber_social, $whatsapp_social, $skype_social;?>
