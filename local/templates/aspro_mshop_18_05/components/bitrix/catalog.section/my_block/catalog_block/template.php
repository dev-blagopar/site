	...
	<?}?>
		...
		<?foreach($arResult["ITEMS"] as $arItem){?>
			...
			<div class="catalog_item_wrapp">
                ...
                $strPack = (string)$arItem["PROPERTIES"]["PACKAGING_1C"]["VALUE"];

				$COEF = (int)$arItem["PROPERTIES"]["COEF_PACKAGING_1C"]["VALUE"];
...
//$strMeasure = $strPack;
	...
	foreach($arItem["PRICES"] as $key => $vol){
               /*$arItem["PRICES"][$key]["VALUE_NOVAT"] = (int)$arItem["PRICES"][$key]["VALUE_NOVAT"] * $COEF;

            $arItem["PRICES"][$key]["PRINT_VALUE_NOVAT"] = $arItem["PRICES"][$key]["VALUE_NOVAT"]." руб.";

            $arItem["PRICES"][$key]["VALUE_VAT"] = (int)$arItem["PRICES"][$key]["VALUE_VAT"] * $COEF;

            $arItem["PRICES"][$key]["PRINT_VALUE_VAT"] = $arItem["PRICES"][$key]["VALUE_VAT"]." руб.";;

            $arItem["PRICES"][$key]["VATRATE_VALUE"] = (int)$arItem["PRICES"][$key]["VATRATE_VALUE"] * $COEF;

            $arItem["PRICES"][$key]["PRINT_VATRATE_VALUE"] = $arItem["PRICES"][$key]["VATRATE_VALUE"]." руб.";

            $arItem["PRICES"][$key]["DISCOUNT_VALUE_NOVAT"] = (int)$arItem["PRICES"][$key]["DISCOUNT_VALUE_NOVAT"] * $COEF;

            $arItem["PRICES"][$key]["PRINT_DISCOUNT_VALUE_NOVAT"] = $arItem["PRICES"][$key]["DISCOUNT_VALUE_NOVAT"]." руб.";

            $arItem["PRICES"][$key]["DISCOUNT_VALUE_VAT"] = (int)$arItem["PRICES"][$key]["DISCOUNT_VALUE_VAT"] * $COEF;

            $arItem["PRICES"][$key]["PRINT_DISCOUNT_VALUE_VAT"] =  $arItem["PRICES"][$key]["DISCOUNT_VALUE_VAT"]." руб.";

            $arItem["PRICES"][$key]["DISCOUNT_VATRATE_VALUE"] = (int)$arItem["PRICES"][$key]["DISCOUNT_VATRATE_VALUE"] * $COEF;

            $arItem["PRICES"][$key]["PRINT_DISCOUNT_VATRATE_VALUE"] = $arItem["PRICES"][$key]["DISCOUNT_VATRATE_VALUE"]." руб.";

            $arItem["PRICES"][$key]["VALUE"] = (int)$arItem["PRICES"][$key]["VALUE"] * $COEF;

            $arItem["PRICES"][$key]["PRINT_VALUE"] = $arItem["PRICES"][$key]["VALUE"]." руб.";

            $arItem["PRICES"][$key]["DISCOUNT_VALUE"] = (int)$arItem["PRICES"][$key]["DISCOUNT_VALUE"] * $COEF;

            $arItem["PRICES"][$key]["PRINT_DISCOUNT_VALUE"] = $arItem["PRICES"][$key]["DISCOUNT_VALUE"]." руб.";

            $arItem["PRICES"][$key]["DISCOUNT_DIFF"] = (int)$arItem["PRICES"][$key]["DISCOUNT_DIFF"] * $COEF;

            $arItem["PRICES"][$key]["PRINT_DISCOUNT_DIFF"] = $arItem["PRICES"][$key]["DISCOUNT_DIFF"]." руб.";
									...
									<?}elseif ( $arItem["PRICES"] ){?>
										...
										<?foreach($arItem["PRICES"] as $key => $arPrice){?>
											...
											<?if($arPrice["CAN_ACCESS"]){
												...
												<?}?>
												<?if ($strPack <> ''){?>
													<div class="description">(Продается упаковками <?=$strPack?>)</div>
												<?}?>
											<?}?>
