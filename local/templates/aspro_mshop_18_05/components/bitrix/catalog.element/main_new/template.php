...
$strPack=$arResult["PROPERTIES"]["PACKAGING_1C"]["VALUE"];

$COEF=(int)$arResult["PROPERTIES"]["COEF_PACKAGING_1C"]["VALUE"];
...
$arViewedData = array(
	...
	'PICTURE_ID' => $arFirstPhoto ? $arFirstPhoto['ID'] : false,
...
foreach($arResult["PRICES"] as $key => $vol){

		$arResult["PRICES"][$key]["VALUE_NOVAT"] = (int)$arResult["PRICES"][$key]["VALUE_NOVAT"] * $COEF;

		$arResult["PRICES"][$key]["PRINT_VALUE_NOVAT"] = $arResult["PRICES"][$key]["VALUE_NOVAT"]." руб.";

        $arResult["PRICES"][$key]["VALUE_VAT"] = (int)$arResult["PRICES"][$key]["VALUE_VAT"] * $COEF;

        $arResult["PRICES"][$key]["PRINT_VALUE_VAT"] = $arResult["PRICES"][$key]["VALUE_VAT"]." руб.";;

        $arResult["PRICES"][$key]["VATRATE_VALUE"] = (int)$arResult["PRICES"][$key]["VATRATE_VALUE"] * $COEF;

        $arResult["PRICES"][$key]["PRINT_VATRATE_VALUE"] = $arResult["PRICES"][$key]["VATRATE_VALUE"]." руб.";

        $arResult["PRICES"][$key]["DISCOUNT_VALUE_NOVAT"] = (int)$arResult["PRICES"][$key]["DISCOUNT_VALUE_NOVAT"] * $COEF; 

        $arResult["PRICES"][$key]["PRINT_DISCOUNT_VALUE_NOVAT"] = $arResult["PRICES"][$key]["DISCOUNT_VALUE_NOVAT"]." руб.";

        $arResult["PRICES"][$key]["DISCOUNT_VALUE_VAT"] = (int)$arResult["PRICES"][$key]["DISCOUNT_VALUE_VAT"] * $COEF;

        $arResult["PRICES"][$key]["PRINT_DISCOUNT_VALUE_VAT"] =  $arResult["PRICES"][$key]["DISCOUNT_VALUE_VAT"]." руб.";

        $arResult["PRICES"][$key]["DISCOUNT_VATRATE_VALUE"] = (int)$arResult["PRICES"][$key]["DISCOUNT_VATRATE_VALUE"] * $COEF;

        $arResult["PRICES"][$key]["PRINT_DISCOUNT_VATRATE_VALUE"] = $arResult["PRICES"][$key]["DISCOUNT_VATRATE_VALUE"]." руб.";

        $arResult["PRICES"][$key]["VALUE"] = (int)$arResult["PRICES"][$key]["VALUE"] * $COEF;

		$arResult["PRICES"][$key]["PRINT_VALUE"] = $arResult["PRICES"][$key]["VALUE"]." руб.";

        $arResult["PRICES"][$key]["DISCOUNT_VALUE"] = (int)$arResult["PRICES"][$key]["DISCOUNT_VALUE"] * $COEF;

        $arResult["PRICES"][$key]["PRINT_DISCOUNT_VALUE"] = $arResult["PRICES"][$key]["DISCOUNT_VALUE"]." руб.";

        $arResult["PRICES"][$key]["DISCOUNT_DIFF"] = (int)$arResult["PRICES"][$key]["DISCOUNT_DIFF"] * $COEF;

        $arResult["PRICES"][$key]["PRINT_DISCOUNT_DIFF"] = $arResult["PRICES"][$key]["DISCOUNT_DIFF"]." руб.";                     
