...
<?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"SHOW_PRODUCTS_".\Bitrix\Main\Config\Option::get("aspro.max", "CATALOG_IBLOCK_ID", "151") => "Y",
		"PROPERTY_CODE_".\Bitrix\Main\Config\Option::get("aspro.max", "CATALOG_IBLOCK_ID", "151") => array(
			0 => "",
			1 => "",
		),
		"CART_PROPERTIES_".\Bitrix\Main\Config\Option::get("aspro.max", "CATALOG_IBLOCK_ID", "151") => array(
		),
		"ADDITIONAL_PICT_PROP_".\Bitrix\Main\Config\Option::get("aspro.max", "CATALOG_IBLOCK_ID", "151") => "MORE_PHOTO",
		"LABEL_PROP_".\Bitrix\Main\Config\Option::get("aspro.max", "CATALOG_IBLOCK_ID", "151") => "-",
