...
<?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"IBLOCK_LINK_SERVICES_ID" => "147",
		"IBLOCK_LINK_TIZERS_ID" => "135",
		"IBLOCK_LINK_REVIEWS_ID" => "144",
		"IBLOCK_LINK_STAFF_ID" => "141",
		"IBLOCK_LINK_VACANCY_ID" => "127",
		"IBLOCK_LINK_BLOG_ID" => "142",
		"IBLOCK_LINK_PROJECTS_ID" => "140",
		"IBLOCK_LINK_BRANDS_ID" => "155",
		"IBLOCK_LINK_LANDINGS_ID" => "142",
